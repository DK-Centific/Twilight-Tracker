...
console.log('Moderator overnight stale-team self-test (1.3.091824c)');

assert('APP_VERSION 1.3.091824c',
  /const APP_VERSION = '1\.3\.091824c'/.test(src)
  && html.includes('twilight.js?v=twilight-1.3.091824c'));
