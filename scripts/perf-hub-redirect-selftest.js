...
console.log('Performance hub redirect + click latency (1.3.091823a)');

assert('APP_VERSION 1.3.091823a',
  /const APP_VERSION = '1\.3\.091823a'/.test(src)
  && html.includes('twilight.js?v=twilight-1.3.091823a'));
